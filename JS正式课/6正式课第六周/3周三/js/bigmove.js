...
~function(){
    ...
    function move(opt){
        ...
        for (var attr in opt){
            defaultOpt[attr]=opt[attr];//用户传了，就按用户的来，否则按默认的来
        }
        ...
        if (typeof defaultOpt.effect ==='number'){
            ...
            tmpEffect = defaultOpt.effect.length >= 2 ? wjEffect[defaultOpt.effect[0]][defaultOpt.effect[1]] : wjEffect[defaultOpt.effect[0]]
        }
        //为linear做准备
        var begin ={},change = {};
        var time = null;
